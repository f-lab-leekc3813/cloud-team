...
#광주
wp = requests.get("https://www.daangn.com/region/%EA%B4%91%EC%A3%BC%EA%B4%91%EC%97%AD%EC%8B%9C")
...
def func(item):
    ...
    return di
url = "https://www.daangn.com/region/%EA%B4%91%EC%A3%BC%EA%B4%91%EC%97%AD%EC%8B%9C"
r = requests.get(url)
...
# csv저장
# df.to_csv("gwangju.csv", index = False)
...
df.to_sql(name='gwangju', con=engine, if_exists='replace', index=False) 