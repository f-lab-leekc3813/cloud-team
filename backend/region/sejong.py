...
#세종
wp = requests.get("https://www.daangn.com/region/%EC%84%B8%EC%A2%85%ED%8A%B9%EB%B3%84%EC%9E%90%EC%B9%98%EC%8B%9C")
...
def func(item):
    ...
    return di
url = "https://www.daangn.com/region/%EC%84%B8%EC%A2%85%ED%8A%B9%EB%B3%84%EC%9E%90%EC%B9%98%EC%8B%9C"
r = requests.get(url)
...
# csv저장
# df.to_csv("sejong.csv", index = False)
...
df.to_sql(name='sejong', con=engine, if_exists='replace', index=False)