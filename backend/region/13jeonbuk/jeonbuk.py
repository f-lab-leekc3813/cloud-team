...
import os
if not os.path.exists('images/jb'): #이미지폴더
    os.makedirs('images/jb') #이미지폴더
img_list = []
...
for i in range(len(img_list)):
    image(i)
df['image'] = ['images/jb/jbimg' + str(i) + '.jpg' for i in range(len(df))]

df

df.to_csv("jeonbuk.csv", index = False)
